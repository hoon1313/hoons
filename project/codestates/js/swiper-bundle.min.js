...
!function (e, t) {
            ...
            for (let e = 0; e < a.length; e += 1) {
                ...
                const d = (n + (
                        s.centeredSlides
                            ? t.minTranslate()
                            : 0
                    ) - o) / (l.swiperSlideSize + s.spaceBetween),
                    c = (n - r[0] + (
                        s.centeredSlides
                            ? t.minTranslate()
                            : 0
    ...
    var k = {
        ...
        slideNext: function (e, t, s) {
            ...
            "auto" === n.slidesPerView && 1 === n.slidesPerGroup && n.slidesPerGroupAuto && (
    ...
    var z = {
        loopCreate: function () {
            ...
            e.loopedSlides > n.length && e.params.loopedSlidesLimit && (
        ...
        loopFix: function () {
            ...
            if (t < a) {
                o = s.length - 3 * a + t,
                o += a;
                e.slideTo(o, 0, !1, !0) && 0 !== d && e.setTranslate((
                    l
                        ? -e.translate
                        : e.translate
                ) - d)
    ...
    function O(e) {
        ...
        if (i.isTouchEvent && "touchmove" !== c.type) 
            return;
        const p = "touchmove" === c.type && c.targetTouches && (
        ...
        if (
            ...
            v > 0 && i.currentTranslate > s.minTranslate()
                ...
                : v < 0 && i.currentTranslate < s.maxTranslate() && (
                    w = !1,
    ...
    function I(e) {
        ...
        a.grabCursor && s.isMoved && s.isTouched && (
        ...
        for (
            let e = 0; e < n.length; e += e < a.slidesPerGroupSkip
                ? 1
                : a.slidesPerGroup
        ) {
    ...
    const H = (e, t) => {
        ...
        if (d.touch) {
            const t = !(
                "touchstart" !== r.start || !d.passiveListener || !i.passiveListeners
            ) && {
                passive: !0,
                capture: !1
            };
    ...
    function ie(e, t, s) {
        ...
        let r = i.children(`.${a}`);
        return r.length || (r = d(
            `<div class="swiper-slide-shadow${s
                ? `-${s}`
                : ""}"></div>`
        ), i.append(r)),
        r
    ...
    const re = [
        function (e) {
            ...
            i("init update resize", (() => {
                s.params.virtual.enabled && s.params.cssMode && v(
                    s.wrapperEl,
                    "--swiper-virtual-size",
                    `${s.virtualSize}px`
                )
                    ...
                    t.isHorizontal()
                        ...
                        : ((d || c || h || m) && (
                            a.preventDefault
                                ? a.preventDefault()
                                : a.returnValue = !1
                        ), (c || m) && t.slideNext(), (d || h) && t.slidePrev()),
                    n("keyPress", i)
                }
            }
            function p() {
        ...
        function (e) {
            ...
            function g(e) {
                return !(
                    ...
                    !(t.params.mousewheel.thresholdTime && u() - c < t.params.mousewheel.thresholdTime) && (e.delta >= 6 && u() - c < 60 || (
                        e.direction < 0
            ...
            function v(e) {
                ...
                if (
                    ...
                    if (
                        h.push(s),
                        a
                            ? (s.direction !== a.direction || s.delta > a.delta || s.time > a.time + 150) && g(
                                s
                            )
                            : g(s),
                        function (e) {
        ...
        function (e) {
            ...
            function p() {
                ...
                if (
                    ...
                    ), s.dynamicMainBullets > 1 && void 0 !== t.previousIndex && (
                        l += p - (t.previousIndex - t.loopedSlides || 0),
                        l > s.dynamicMainBullets - 1
                            ? l = s.dynamicMainBullets - 1
                            : l < 0 && (l = 0)
                    ), i = Math.max(p - l, 0), o = i + (
                ...
                if (
                    "fraction" === s.type && (r.find(U(s.currentClass)).text(s.formatFractionCurrent(
                        p + 1
                ...
                t.params.watchOverflow && t.enabled && r[
                    t.isLocked
                        ? "addClass"
                        : "removeClass"
                ](s.lockClass)
            ...
            function u() {
                ...
                if ("bullets" === e.type) {
                    let i = t.params.loop
                        ...
                        : t.snapGrid.length;
                    t.params.freeMode && t.params.freeMode.enabled && !t.params.loop && i > s && (
                        i = s
                    );
                    for (let s = 0; s < i; s += 1) 
                        e.renderBullet
            ...
            function h() {
                ...
                let s = d(e.el);
                0 !== s.length && (
                    t.params.uniqueNavElements && "string" == typeof e.el && s.length > 1 && (
                        s = t.$el.find(e.el),
        ...
        function (e) {
            ...
            function v() {
                ...
                t.params.watchOverflow && t.enabled && e.$el[
                    t.isLocked
                        ? "addClass"
                        : "removeClass"
        ...
        function (e) {
            ...
            function x(e) {
                ...
                m.$imageEl && 0 !== m.$imageEl.length
                    ? (
                        ...
                        i.scale > m.maxRatio && (
                            i.scale = m.maxRatio - 1 + (i.scale - m.maxRatio + 1) ** .5
                        ),
                        i.scale < a.minRatio && (
                            i.scale = a.minRatio + 1 - (a.minRatio - i.scale + 1) ** .5
                        ),
            ...
            function C() {
                const e = t.zoom;
                m.$slideEl && t.previousIndex !== t.activeIndex && (
            ...
            function M() {
                ...
                return {
                    passiveListener: !(
                        "touchstart" !== t.touchEvents.start || !e.passiveListener || !t.params.passiveListeners
                    ) && {
                        passive: !0,
                        capture: !1
                    },
            ...
            a("touchStart", ((e, s) => {
                t.zoom.enabled && function (e) {
                    const s = t.device;
                    m.$imageEl && 0 !== m.$imageEl.length && (f.isTouched || (
                        s.android && e.cancelable && e.preventDefault(),
                        f.isTouched = !0,
                        f.touchesStart.x = "touchstart" === e.type
                            ? e.targetTouches[0].pageX
                            : e.pageX,
                        f.touchesStart.y = "touchstart" === e.type
                            ? e.targetTouches[0].pageY
                            : e.pageY
                    ))
                }(s)
        ...
        function (e) {
            ...
            a("beforeInit", (() => {
                t.params.lazy.enabled && t.params.preloadImages && (
        ...
        function (e) {
            ...
            function m(e) {
                ...
                const s = t.params.a11y,
                    a = d(e.target);
                t.navigation && t.navigation.$nextEl && a.is(t.navigation.$nextEl) && (
                    t.isEnd && !t.params.loop || t.slideNext(),
                    t.isEnd
                        ? r(s.lastSlideMessage)
                        : r(s.nextSlideMessage)
                ),
                t.navigation && t.navigation.$prevEl && a.is(t.navigation.$prevEl) && (
            ...
            a("paginationUpdate", (() => {
                t.params.a11y.enabled && function () {
                    ...
                    f() && t
                        ...
                        .each((s => {
                            const a = d(s);
                            t.params.pagination.clickable && (n(a), t.params.pagination.renderBullet || (
                                o(a, "button"),
        ...
        function (e) {
            ...
            function o() {
                return void 0 === t && (
                    !s.autoplay.running && (s.autoplay.running = !0, n("autoplayStart"), l(), !0)
                )
            }
            function d() {
            ...
            function c(e) {
                s.autoplay.running && (s.autoplay.paused || (
                    t && clearTimeout(t),
                    s.autoplay.paused = !0,
            ...
            function u() {
                ...
                "visible" === e.visibilityState && s.autoplay.paused && (
                    l(),
                    s.autoplay.paused = !1
                )
            }
            ...
            te({
                ...
                setTranslate: () => {
                    ...
                    const g = c.isSafari || c.isWebView
                        ...
                        : 0;
                    s.transform(
                        `translate3d(0px,0,${g}px) rotateX(${t.isHorizontal()
                            ? 0
                ...
                setTranslate: () => {
                    ...
                    for (let e = 0, t = a.length; e < t; e += 1) {
                        ...
                        if (
                            ...
                            e.length && (
                                e[0].style.opacity = p > 0
                                    ? p
                                    : 0
                            ),
                            s.length && (
                                s[0].style.opacity = -p > 0
                                    ? -p
                                    : 0
                            )
                        }
                ...
                setTranslate: () => {
                    ...
                    for (let l = 0; l < e.length; l += 1) {
                        ...
                        if (a.slideShadows) {
                            ...
                            0 === e.length && (e = ie(a, o)),
                            e.length && (
                                e[0].style.opacity = Math.min(Math.max((Math.abs(c) - .5) / .5, 0), 1)
                            )
                        }
